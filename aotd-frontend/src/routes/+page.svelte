    ...
    <div class="space-y-10 text-center flex flex-col items-center p-10">
      ...
      <div class="card p-5 max-w-2xl">
        ...
        <p class="text-lg">
          ...
          (AotD) is here to brighten up your day with a little artwork just for
          you!
        </p>
      </div>
      ...
      <div class="card p-5 max-w-2xl">
        ...
        <div
          class="logo-cloud grid-cols-1 lg:!grid-cols-4 gap-1 bg-transparent"
        >
          <a
          ...
          >
            <div>
              <box-icon type="logo" size="md" name="github" color="white" />
              <span>GitHub</span>
            </div>
          </a>
          <a
          ...
          >
            <div>
              <box-icon size="md" name="server" color="white" />
              <span>Django</span>
            </div>
          </a>
